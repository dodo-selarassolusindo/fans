 ...
 * Page class
 */
class ExportlogDelete extends Exportlog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExportlogDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "exportlogdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("exportloglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("exportloglist"); // Return to list
                return;
            }
        }
