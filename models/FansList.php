...
class FansList extends Fans
{
    ...
    public $FormName = "ffanslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "fanslist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "fansdelete";
        $this->MultiUpdateUrl = "fansupdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->FansID->AdvancedSearch->toJson(), ","); // Field FansID
        ...
        $filterList = Concat($filterList, $this->TahunKelahiran->AdvancedSearch->toJson(), ","); // Field TahunKelahiran
        ...
        $filterList = Concat($filterList, $this->AcaraID->AdvancedSearch->toJson(), ","); // Field AcaraID
        $filterList = Concat($filterList, $this->RadioID->AdvancedSearch->toJson(), ","); // Field RadioID
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("ffanssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field FansID
        $this->FansID->AdvancedSearch->SearchValue = @$filter["x_FansID"];
        $this->FansID->AdvancedSearch->SearchOperator = @$filter["z_FansID"];
        $this->FansID->AdvancedSearch->SearchCondition = @$filter["v_FansID"];
        $this->FansID->AdvancedSearch->SearchValue2 = @$filter["y_FansID"];
        $this->FansID->AdvancedSearch->SearchOperator2 = @$filter["w_FansID"];
        $this->FansID->AdvancedSearch->save();
        ...
        $this->TahunKelahiran->AdvancedSearch->SearchValue = @$filter["x_TahunKelahiran"];
        $this->TahunKelahiran->AdvancedSearch->SearchOperator = @$filter["z_TahunKelahiran"];
        $this->TahunKelahiran->AdvancedSearch->SearchCondition = @$filter["v_TahunKelahiran"];
        $this->TahunKelahiran->AdvancedSearch->SearchValue2 = @$filter["y_TahunKelahiran"];
        $this->TahunKelahiran->AdvancedSearch->SearchOperator2 = @$filter["w_TahunKelahiran"];
        $this->TahunKelahiran->AdvancedSearch->save();
        ...
        // Field AcaraID
        $this->AcaraID->AdvancedSearch->SearchValue = @$filter["x_AcaraID"];
        $this->AcaraID->AdvancedSearch->SearchOperator = @$filter["z_AcaraID"];
        $this->AcaraID->AdvancedSearch->SearchCondition = @$filter["v_AcaraID"];
        $this->AcaraID->AdvancedSearch->SearchValue2 = @$filter["y_AcaraID"];
        $this->AcaraID->AdvancedSearch->SearchOperator2 = @$filter["w_AcaraID"];
        $this->AcaraID->AdvancedSearch->save();

        // Field RadioID
        $this->RadioID->AdvancedSearch->SearchValue = @$filter["x_RadioID"];
        $this->RadioID->AdvancedSearch->SearchOperator = @$filter["z_RadioID"];
        $this->RadioID->AdvancedSearch->SearchCondition = @$filter["v_RadioID"];
        $this->RadioID->AdvancedSearch->SearchValue2 = @$filter["y_RadioID"];
        $this->RadioID->AdvancedSearch->SearchOperator2 = @$filter["w_RadioID"];
        $this->RadioID->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->TahunKelahiran;
        $searchFlds[] = &$this->Profesi;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->FansID); // FansID
            $this->updateSort($this->Nama); // Nama
            $this->updateSort($this->Gender); // Gender
            $this->updateSort($this->NomorHP); // NomorHP
            $this->updateSort($this->TahunKelahiran); // TahunKelahiran
            $this->updateSort($this->Kota); // Kota
            $this->updateSort($this->Profesi); // Profesi
            $this->updateSort($this->Hobi); // Hobi
            $this->updateSort($this->AcaraID); // AcaraID
            $this->updateSort($this->RadioID); // RadioID
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->TahunKelahiran->setSort("");
                $this->Kota->setSort("");
                $this->Profesi->setSort("");
                $this->Hobi->setSort("");
                $this->AcaraID->setSort("");
                $this->RadioID->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"fans\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"fans\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"fans\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ffanslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ffanslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->FansID->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"fans\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "FansID");
            $this->createColumnOption($option, "Nama");
            $this->createColumnOption($option, "Gender");
            $this->createColumnOption($option, "NomorHP");
            $this->createColumnOption($option, "TahunKelahiran");
            $this->createColumnOption($option, "Kota");
            $this->createColumnOption($option, "Profesi");
            $this->createColumnOption($option, "Hobi");
            $this->createColumnOption($option, "AcaraID");
            $this->createColumnOption($option, "RadioID");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ffanssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ffanssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ffanslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_fans", "data-rowtype" => RowType::ADD]);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="ffanslist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ffanssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
