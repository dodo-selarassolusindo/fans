...
class RadioView extends Radio
{
    ...
    // CSS class/style
    public $CurrentPageName = "radioview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("RadioID") ?? Route("RadioID")) !== null) {
            ...
            $this->RecKey["RadioID"] = $this->RadioID->QueryStringValue;
        } elseif (Post("RadioID") !== null) {
            $this->RadioID->setFormValue(Post("RadioID"));
            $this->RecKey["RadioID"] = $this->RadioID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->RadioID->setQueryStringValue($keyValue);
            $this->RecKey["RadioID"] = $this->RadioID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "radiolist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "radiolist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
