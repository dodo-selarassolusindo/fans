...
class AcaraView extends Acara
{
    ...
    // CSS class/style
    public $CurrentPageName = "acaraview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("AcaraID") ?? Route("AcaraID")) !== null) {
            ...
            $this->RecKey["AcaraID"] = $this->AcaraID->QueryStringValue;
        } elseif (Post("AcaraID") !== null) {
            $this->AcaraID->setFormValue(Post("AcaraID"));
            $this->RecKey["AcaraID"] = $this->AcaraID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->AcaraID->setQueryStringValue($keyValue);
            $this->RecKey["AcaraID"] = $this->AcaraID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "acaralist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "acaralist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
