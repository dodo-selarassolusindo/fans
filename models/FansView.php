...
class FansView extends Fans
{
    ...
    // CSS class/style
    public $CurrentPageName = "fansview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("FansID") ?? Route("FansID")) !== null) {
            ...
            $this->RecKey["FansID"] = $this->FansID->QueryStringValue;
        } elseif (Post("FansID") !== null) {
            $this->FansID->setFormValue(Post("FansID"));
            $this->RecKey["FansID"] = $this->FansID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->FansID->setQueryStringValue($keyValue);
            $this->RecKey["FansID"] = $this->FansID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "fanslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "fanslist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
