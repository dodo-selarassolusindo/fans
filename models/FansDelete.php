...
class FansDelete extends Fans
{
    ...
    // CSS class/style
    public $CurrentPageName = "fansdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("fanslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("fanslist"); // Return to list
                return;
            }
        }
