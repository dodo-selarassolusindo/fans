...
<span id="el_fans_Kota">
    <select
        ...
        data-select2-id="ffansadd_x_Kota"
        data-table="fans"
        data-field="x_Kota"
...
<script>
loadjs.ready("ffansadd", function() {
    var options = { name: "x_Kota", selectId: "ffansadd_x_Kota" };
    if (ffansadd.lists.Kota?.lookupOptions.length) {
        options.data = { id: "x_Kota", form: "ffansadd" };
    } else {
        options.ajax = { id: "x_Kota", form: "ffansadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_fans_AcaraID">
    <select
        ...
        data-select2-id="ffansadd_x_AcaraID"
        data-table="fans"
...
<script>
loadjs.ready("ffansadd", function() {
    var options = { name: "x_AcaraID", selectId: "ffansadd_x_AcaraID" };
    if (ffansadd.lists.AcaraID?.lookupOptions.length) {
        options.data = { id: "x_AcaraID", form: "ffansadd" };
    } else {
        options.ajax = { id: "x_AcaraID", form: "ffansadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_fans_RadioID">
    <select
        ...
        data-select2-id="ffansadd_x_RadioID"
        data-table="fans"
...
<script>
loadjs.ready("ffansadd", function() {
    var options = { name: "x_RadioID", selectId: "ffansadd_x_RadioID" };
    if (ffansadd.lists.RadioID?.lookupOptions.length) {
        options.data = { id: "x_RadioID", form: "ffansadd" };
    } else {
        options.ajax = { id: "x_RadioID", form: "ffansadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
